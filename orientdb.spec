...
sed -i 's/User=.*/User="orientdb"/' bin/orientdb.service
sed -i 's/Group.*/Group="orientdb"/' bin/orientdb.service
sed -i 's/$ORIENTDB_HOME/\/opt\/orientdb-%{version}/' bin/orientdb.service
